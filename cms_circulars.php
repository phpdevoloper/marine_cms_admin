...
<div id="AddModal" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form  name="form" method="post" action="circular_sub.php" enctype="multipart/form-data">
				...
				<div class="form-group">
				   ...
				   <div class="form-group">
					<label for="release_dt">Date Released</label>
					<input type="date" class="form-control" id="release_dt_add" name="release_dt_add"   required/>
				</div>
				  <div class="form-group">
					<label for="validupto">Validupto</label>
					<input type="date" class="form-control" id="validupto_add" name="validupto_add" min=<?php echo date('Y-m-d'); ?>  required/>
				  </div>
				   <div class="form-group">
            ...
            <div id="updateModal" class="modal fade" role="dialog">
                <div class="modal-dialog">
					...
					<div class="form-group">
					<label for="release_dt">Date Released</label>
					<input type="date" class="form-control" id="release_dt" name="release_dt"   required/>
					</div>
					<div class="form-group">
					<label for="validupto">Validupto</label>
           ...
           var userDataTable = $('#userTable').DataTable({
            ...
            $('#userTable').on('click','.updateUser',function(){
                ...
                $.ajax({
					...
					$('#txt_userid_edit').val(response.data.cir_id);
