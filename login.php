...
.tabcontent {
				...
				<div class="container">
					<div class="row">
						 ...
						 <div class="login-form-title-3">
                            ...
                            <div class="login-form-box-3">
								...
								<div id="err">
                                        ...
                                        <form role="form" id="login" method="POST" action="login_tt.php" autocomplete="off">
                     ...
                     <div class="form-group">
                        ...
                        <input type="email" class="form-input"  name="email_signin" id="email_signin"  class="login username-field form-control" autofocus/>
                        ...
                        <input type="password" class="form-input"  name="password_signin" id="password_signin" class="login password-field form-control"
                            id="password_signin" />
 ...
 <div class="button-style">
                    <button id="btnsubmit" type="Login" class="button login">Sign
                        in</button>
						 <input type="hidden" name="txthid"  id="txthid" value='<?php echo $_SESSION['rand']; ?>'/></div>
...
$('#login').on('submit', function (e)
	 ...
	 var emailReg = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
		...
		if(emailaddressVal == '') {
			$("#email_error").html('');
			$("#email_signin").after('<label class="lbl lbl-error" id="email_error">Please enter your email address.</label>');
			return false
		}
		else if(!emailReg.test(emailaddressVal)) {
			$("#email_error").html('');
			$("#email_signin").after('<label class="lbl lbl-error" id="email_error">Enter a valid email address.</label>');
			return false
		...
		{
			$("#email_error").html('');
			$("#password_signin").after('<label class="lbl lbl-error" id="email_error">Please enter your password.</label>');
			return false
		}
		else
		{
	    ...
	    $.ajax({
                type: "POST",
                url: 'vallogin.php',
                data: "useremail="+$('input[id=email_signin]').val()+"&pwd="+$('input[name=password_signin]').val()+"&capt="+$('input[name=captcha]').val(),              				
				 encode:true,	
