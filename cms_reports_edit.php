...
$msg.="Check Url";
 ...
 $str="update reports_mst set title='".$title."',doc_type='".$doc_type."',category='".$category."',url_txt='".$url."',doc_path='".$path_filename_ext."',doc_size='".$sfile_size."' where rep_id=".$id; 
...
$msg.="Check Url";
 ...
 $str="update reports_mst set title='".$title."',doc_type='".$doc_type."',category='".$category."',url_txt='".$url."' where rep_id=".$id; 
//  var_dump($str);exit;return false;
$execQuery_in=pg_query($connection,$str);
		}
}
	header("Location: cms_reports.php"); 
					?>