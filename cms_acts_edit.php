...
$msg.="Check Url";
 ...
 $str="update acts_mst set title='".$title."',doc_type='".$doc_type."',category='".$category."',url_txt='".$url."',doc_path='".$path_filename_ext."',doc_size='".$sfile_size."' where act_id=".$id; 
