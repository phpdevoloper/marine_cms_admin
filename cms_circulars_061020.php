...
if (file_exists($path_filename_ext)) {
 ...
 move_uploaded_file($temp_name,$path_filename_ext);
		 ...
		 $validupto=$_POST["validupto"];
			$str="insert into circular_mst (type,category,title,release_dt,dt_upto,doc_path,submittedby) values('".$type."','".$category."','".$title."','".$reldate."','".$validupto."','".$path_filename_ext."','". $_SESSION['email']."')";
