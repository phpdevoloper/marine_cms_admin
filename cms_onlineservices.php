                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form  name="form" method="post" action="oserv_sub.php" enctype="multipart/form-data">
							<div class="form-group">
					<label for="type">Select Type</label>
					<select  class="form-control" id="type_add" name="type_add" required>
						<option value='o' selected readonly>Online Services</option>
           ...
           var userDataTable = $('#userTable').DataTable({
            ...
            $('#userTable').on('click','.updateUser',function(){
                ...
                $.ajax({
					...
					$('#txt_userid_edit').val(response.data.oserv_id);
